...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'dillan1@ethereal.email'
EMAIL_HOST_PASSWORD = 'xZFddVr42UThXc7V3k'
DEFAULT_FROM_EMAIL = 'dillan1@ethereal.email'

AUTHENTICATION_BACKENDS = [
    'ems.authentication.EmployeeBackend',
